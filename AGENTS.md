...
- Dependencies: `python3-nautilus`, `zenity` (for dialogs), `gnome-terminal`, `ugrep` (for the interactive Search TUI), `pdftotext` (optional, from `poppler-utils` for PDF search).
